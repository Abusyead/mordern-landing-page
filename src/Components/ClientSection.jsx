  ...
  return (
       <section className='py-16 px-4 max-w-7xl mx-auto' id='testimonials'>
        <div className='text-center mb-12'>
            <h2 className='text-3xl font-bold md:test-4xl mb-4'>What our happy client say</h2>
            <p className="text-gray-600">Things that make it best place to start tranding</p>
        </div>
        ...
        <div className='relative'>
            {/* swiper cards */}
                    ...
                    <div className=' shadow-2xl shadow-amber-100 bg-red-400'>
                        {
                        testimonials.map((testimonial , index) =>(
                            <SwiperSlide key={index} className='h-full md:py-12 py-4 border-b-8 border-gray-200'>
                                <div className='flex items-center justify-center flex-col text-center'>
                                    ...
                                    <div className='flex items-center mb-2'>
                                        {[...Array(5)].map((_, startIndex) => (
                                            <FaStar key={startIndex} className='text-amber-300  '/>
            ...
            {/* naviagational button */}

            <div className='flex justify-center items-center gap-4 md:mt-25 mt-15'>
